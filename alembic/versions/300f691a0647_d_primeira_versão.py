...
Revision ID: 300f691a0647
Revises: 
Create Date: 2025-04-24 22:40:05.636606
...
def upgrade() -> None:
    ...
    sa.Column('id_pk', sa.Integer(), autoincrement=True, nullable=False),
    ...
    sa.Column('taxa_limpeza', sa.Float(), nullable=False),
    ...
    op.create_table('corretores_proprietarios',
    sa.Column('pk_id', sa.Integer(), nullable=False),
    ...
    sa.Column('deleted_at', sa.DateTime(), nullable=True),
    sa.Column('ativo', sa.Boolean(), nullable=False),
    sa.ForeignKeyConstraint(['corretor_id'], ['corretores.pk_id'], ),
    sa.ForeignKeyConstraint(['imovel_id'], ['imoveis.pk_id'], ),
    sa.ForeignKeyConstraint(['proprietario_id'], ['proprietarios.pk_id'], ),
    sa.PrimaryKeyConstraint('pk_id')
    )
...
def downgrade() -> None:
    ...
    op.drop_table('corretores_proprietarios')
